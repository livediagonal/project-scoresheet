...
data RawStart
  ...
  , rawStartBattingPosition :: !BattingOrderPosition
  , rawStartFieldingPosition :: !FieldingPositionId
  } deriving (Eq, Show, Generic)
...
data RawSub
  ...
  , rawSubBattingPosition :: !BattingOrderPosition
  , rawSubFieldingPosition :: !FieldingPositionId
  } deriving (Eq, Show, Generic)
